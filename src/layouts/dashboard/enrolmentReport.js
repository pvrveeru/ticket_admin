...
function EnrolmentReport() {
  ...
  const handleRegistrationSearch = useCallback(async () => {
    ...
    const url = `Report/GetEnrolmentCountForFlightByDate?fromDate=${formattedStartDate}&toDate=${formattedEndDate}`;
  ...
  const exportregistrationCSV = () => {
    ...
    saveAs(blob, "enrolmentreport.csv");
  };
